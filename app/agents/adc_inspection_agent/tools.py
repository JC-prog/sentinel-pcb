"""Three Tool implementations (app/core/tools.py) wrapping the orchestrator workflow, invoked
through app/agents/registry.py's ToolRegistry/call_tool() the same way any other tool is.
...
from app.agents.adc_inspection_agent.graph import build_graph
