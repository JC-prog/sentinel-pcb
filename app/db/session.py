"""Async engine/session setup. No Alembic for this pass - see the plan doc's M1 rationale:
there's no existing data to migrate yet and no second environment, so `create_all` on startup
is the right amount of ceremony until that stops being true.
"""
