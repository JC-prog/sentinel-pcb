...
model verdict was wrong creates a RetrainingTicket via app/agents/monitoring_agent's
flag_case_for_retraining tool. This only queues the request for engineering to act on - actual
model retraining happens on the separate inference server (app/inference/), never here.
"""
