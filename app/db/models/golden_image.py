...
app/agents/adc_inspection_agent/golden_images.py when a QA user flags an ambiguous image and no
...
class GoldenImage(Base):
    ...
    # References app.uploads' stored-filename convention (uuid4().hex + suffix), not blob data -
    # see app/agents/adc_inspection_agent/golden_images.py's save_golden_image(). Stored under
