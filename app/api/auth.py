"""Routes only - see app/auth/service.py for credential/token business logic. Cookie
get/set/clear lives here rather than in the service layer since it's purely an HTTP response
concern (app/auth/service.py issues tokens without knowing about Response objects or cookies at
all)."""
