"""Routes only - see app/uploads/service.py for storage/path-resolution logic. Generic uploads
(chat-attached images and inspection XML) - distinct from app/api/orchestrator.py's own uploads,
which are stored separately (see app/agents/orchestrator_agent/uploads.py)."""
