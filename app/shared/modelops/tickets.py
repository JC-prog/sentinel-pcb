...
QA/Admin reviewer believes a Case's model verdict was wrong. A ticket only records the claim;
jobs.py's draft_job() is what turns open tickets into a retraining request.
"""
