"""Persistence model for the case-management workflow: app/chat/agents/adc_inspection_agent/ creates a
Case per flagged image (verdict REVIEW_REQUIRED or ACCEPTED); QA/Admin later resolve a
REVIEW_REQUIRED case via review_case (app/chat/agents/adc_inspection_agent/tools.py), moving it to
...
class CaseStatus(StrEnum):
    ...
    to APPROVED/OVERRIDDEN - see app/chat/agents/adc_inspection_agent/repository.py's resolve_case().
    """
