...
app/chat/services/providers/ (ChatService) and app/chat/services/repository.py (persistence); app/chat/services/service.py's
...
class ToolCallRequest(BaseModel):
    ...
    synthesized (Ollama has none) for Ollama; see app/chat/services/providers/*.py's stream_with_tools."""
