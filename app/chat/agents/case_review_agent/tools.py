...
from app.chat.agents.case_review_agent.graph import PCBInspectionState, get_pipeline
...
class InvestigateCaseTool:
    ...
    async def run(self, **kwargs: Any) -> str:
        ...
        # adc_inspection_agent's case repository and app.chat.uploads' path resolver - neither is a
