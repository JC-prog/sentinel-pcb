...
(app/chat/core/tools.py) as ExplainabilityReviewTool, invoked through
app/chat/agents/registry.py's ToolRegistry/call_tool() the same way.
...
app/chat/agents/case_review_agent/mcp_client.py's own graceful-degradation.
"""
...
from app.chat.agents.weather_agent.graph import WeatherAdvisoryState, get_pipeline
...
class WeatherAgentTool:
    ...
    async def run(self, **kwargs: Any) -> str:
        ...
        # app/chat/agents/case_review_agent/tool.py.
