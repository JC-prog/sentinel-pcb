...
app/chat/agents/case_review_agent/graph.py (state TypedDict, sync node functions run off
...
def _query_advisory_llm(state: WeatherAdvisoryState, *, severe: bool) -> str:
    ...
    # (app/chat/agents/case_review_agent/models.py, app/chat/services/providers/openai.py) - never
