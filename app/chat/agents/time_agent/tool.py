...
branch. Same Tool protocol (app/chat/core/tools.py) as WeatherAgentTool/ExplainabilityReviewTool,
invoked through app/chat/agents/registry.py's ToolRegistry/call_tool() the same way.
...
from app.chat.agents.time_agent.graph import TimeState, get_pipeline
