...
class ChatStreamRequest(BaseModel):
    ...
    message: str
    image_ids: list[str] = []
    # Inspection XML upload ids (app.uploads, via POST /api/uploads/xml) - only consumed by
    # create_case (app/agents/adc_inspection_agent/), optional there too. Not persisted on Message
