...
async def get_recent_messages(
    ...
    """Most recent `limit` messages, oldest first - see app/chat/services/history.py's windowing."""
...
async def count_messages_by_role(session: AsyncSession, conversation_id: str, role: str) -> int:
    """Used by app/chat/memory/service.py to throttle extraction to every Nth assistant turn."""
