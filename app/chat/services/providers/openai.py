...
from app.chat.core.chat import ChatMessage, ChatTurn, TextDelta, ToolCallRequest, ToolCallsReady
...
def _chat_completions_url() -> str:
    ...
    most deployments (see app/shared/config/settings.py) and tests monkeypatch it."""
...
class OpenAiChatService:
    ...
    settings.openai_api_key (no per-request bring-your-own-key - see app/shared/config/settings.py).
