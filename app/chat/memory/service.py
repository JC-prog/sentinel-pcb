...
them to seed a new conversation's system prompt. See app/chat/core/memory.py for the MemoryStore/
EmbeddingService interfaces this depends on - app/chat/memory/qdrant_store.py is the only file that
...
from app.chat.memory.embeddings import embedding_model_name, get_embedding_service
