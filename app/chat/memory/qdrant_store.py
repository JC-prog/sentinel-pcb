...
from app.chat.core.memory import MemoryMatch, MemoryRecord
...
class QdrantMemoryStore:
    """MemoryStore backed by Qdrant (settings.qdrant_url) - see app/chat/core/memory.py for why
    ...
    async def ensure_collection(self, *, vector_size: int) -> None:
        ...
        # applied - see this method's caller in app/chat/memory/service.py for why an unindexed/
